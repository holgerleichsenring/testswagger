...
{ 
    ...
    { 
        /// <summary>
        /// Returns list of Plants. This query can be paged. If page and pageSize are omitted,  the full list is going to be returned. When pageSize and page specified,  pageCount and currentPage will be returned on first call.
        /// </summary>
