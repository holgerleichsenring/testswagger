...
{ 
    ...
    /// </summary>
    [ApiController]
    public class InventoryAssetsFullTextAndPropertySearchByStatusDefaultApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpPost]
        [Route("/api/inventoryassets/search/bytextandproperties/bystatusdefault")]
