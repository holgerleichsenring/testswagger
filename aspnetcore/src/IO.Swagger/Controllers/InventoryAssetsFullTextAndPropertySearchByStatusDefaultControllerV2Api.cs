...
{ 
    ...
    /// </summary>
    [ApiController]
    public class InventoryAssetsFullTextAndPropertySearchByStatusDefaultControllerV2ApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpPost]
        [Route("/api/v2/inventoryassets/search/bytextandproperties/bystatusdefault")]
