...
{ 
    ...
    /// </summary>
    [ApiController]
    public class InventoryAssetsFullTextAndPropertySearchByStatusOtherApiController : ControllerBase
    { 
        /// <summary>
        ...
        [HttpPost]
        [Route("/api/inventoryassets/search/bytextandproperties/bystatusother")]
