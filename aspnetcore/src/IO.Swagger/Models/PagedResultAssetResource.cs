...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PagedResultAssetResource : IEquatable<PagedResultAssetResource>
    { 
        /// <summary>
        /// Gets or Sets Results
        /// </summary>
        [DataMember(Name="results")]
        public List<AssetResource> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultAssetResource {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PagedResultAssetResource)obj);
        }

        /// <summary>
        /// Returns true if PagedResultAssetResource instances are equal
        /// </summary>
        /// <param name="other">Instance of PagedResultAssetResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultAssetResource other)
        {
        ...
        public static bool operator ==(PagedResultAssetResource left, PagedResultAssetResource right)
        {
